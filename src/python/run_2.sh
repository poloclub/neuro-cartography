...
python main.py --compute_hash_value_neuron T --gpu 6 --blk mixed4c --batch_size 500
python main.py --compute_hash_value_neuron T --gpu 6 --blk mixed4c_3x3 --batch_size 500
python main.py --compute_hash_value_neuron T --gpu 6 --blk mixed4c_5x5 --batch_size 500
python main.py --compute_hash_value_neuron T --gpu 6 --blk mixed4d --batch_size 500
python main.py --compute_hash_value_neuron T --gpu 6 --blk mixed4d_3x3 --batch_size 500
python main.py --compute_hash_value_neuron T --gpu 6 --blk mixed4d_5x5 --batch_size 500
